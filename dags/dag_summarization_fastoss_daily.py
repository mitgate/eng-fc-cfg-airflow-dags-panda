# Nome da DAG: dag_summarization_fastoss_daily
# Owner / responsável: CoE
# Descrição do objetivo da DAG: Ejecuta una tarea index_parallel en Druid para leer datos desde fastoss-pm-enriched-metrics-temporal-hourly y agregarlos en fastoss-pm-enriched-metrics-temporal-daily-3 consolidando métricas diarias en el ambiente de producción (prd)
#
# Nota: 
# Las funciones usadas están guardadas en el archivo functions_summarization.py
# Usa Druid?: Si
# Principais tabelas / consultas Druid acessadas: fastoss-pm-enriched-metrics-temporal-hourly
...
dag = DAG('dag_summarization_fastoss_daily',
...
with dag:
    ...
    def calculate_summarization(var_execution_date): 
            functions.druid_create_task_summarization(var_execution_date, "DAILY", "temporal", "fastoss", "load")
