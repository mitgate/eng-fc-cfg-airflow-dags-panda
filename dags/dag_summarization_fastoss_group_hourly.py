# Nome da DAG: dag_summarization_fastoss_group_hourly
# Owner / responsável: CoE
# Descrição do objetivo da DAG: Ejecuta una tarea index_parallel en Druid para leer datos desde fastoss-pm-enriched-metrics-group-30m y agregarlos en fastoss-pm-enriched-metrics-group-hourly, consolidando métricas cada hora en el ambiente de producción (prd)
# 
# Nota: 
...
dag = DAG('dag_summarization_fastoss_group_hourly',
...
with dag:
    ...
    def calculate_summarization(var_execution_date): 
        functions.druid_create_task_summarization(var_execution_date, "HOURLY", "spatial", "fastoss", "load")
