# Nome da DAG: dag_summarization_fastoss_interval_hourly
...
def generar_tareas_druid(fecha, **kwargs):
    functions.druid_create_task_summarization(fecha, "HOURLY", "temporal", "fastoss", "interval")    

# Función para insertar un retraso
def esperar():
    time.sleep(12 * 60)  # Espera 
...
with DAG(
    "dag_summarization_fastoss_interval_hourly",
    default_args=default_args,
    #description="DAG con TaskGroup que ejecuta tareas secuenciales",
