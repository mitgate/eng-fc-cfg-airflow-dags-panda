# Nome da DAG: dag_alarms_aggregation_spatial_15M_dev
# Owner / responsável: CoE
# Descrição do objetivo da DAG: 
# 1. Busca en Postgres Dev los thesholds con granularidad = 15 minutos y agregación temporal = None 
...
# 
# Nota: Las funciones usadas están guardadas en el archivo functions_dev.py
# Usa Druid?: Si
...
def execute_druid_adapter_query(**kwargs):
    ...
    start_date = '2024-06-09 17:02:00.000Z'
...
#Definición del Dag
dag = DAG(
    'dag_alarms_aggregation_dev_spatial_15M',  # Nombre de tu DAG
    default_args=default_args,
    schedule_interval  ='3-59/15 * * * *',  # Se jecuta cada 15 min
    catchup=False,
