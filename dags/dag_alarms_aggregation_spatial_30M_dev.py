# Nome da DAG: dag_alarms_aggregation_spatial_30M_dev
# Owner / responsável: CoE
# Descrição do objetivo da DAG: 
# 1. Busca en Postgres Dev los thesholds con granularidad = 30 minutos y agregación temporal = None 
...
#Definición del Dag
dag = DAG(
    'dag_alarms_aggregation_dev_spatial_30M',  # Nombre de tu DAG
