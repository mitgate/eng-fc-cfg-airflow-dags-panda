...
def create_query_groups(param_df, param_execution_date, periodicity):
    ...
    df_config = pd.DataFrame(param_df)
    ...
    for index, row in df_config.iterrows(): 
        ...
        if var_validacion:
            ...
            if  periodicity!='DAILY_BUSY_HOUR':
                max_capacity = int(Variable.get("BH_max_capacity_daily"))
            elif  periodicity!='WEEKLY_BUSY_HOUR':
                max_capacity = int(Variable.get("BH_max_capacity_weekly"))
            elif  periodicity!='NTHLY_BUSY_HOUR':
                max_capacity = int(Variable.get("BH_max_capacity_monthly"))
