# Nome da DAG: dag_alarms_aggregation_temporal_spatial_daily
# Owner / responsável: CoE
# Descrição do objetivo da DAG: 
# 1. Busca en Postgres Prd los thesholds con granularidad = día
...
#Definición del Dag
dag = DAG(
    'dag_alarms_aggregation_temporal_spatial_daily',  # Nombre de tu DAG
