...
# Descrição do objetivo da DAG: Buscar en Symphony Dev la configuración de las Busy Hour con periodicidad SEMANA
...
dag = DAG('dag_busyHour_dev_weekly',
        default_args=default_args,
        #start_date=datetime(2024, 5, 3),
        catchup = False,
        schedule_interval = None,
        #schedule_interval='0 3 * * 1',  # Se ejecuta todos los lunes a las 3:00 am
        tags = ["busyHour"],
