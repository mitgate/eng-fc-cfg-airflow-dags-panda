# Nome da DAG: dag_alarms_aggregation_spatial_30M
# Owner / responsável: CoE
# Descrição do objetivo da DAG: 
# 1. Busca en Postgres Prd los thesholds con granularidad = 30 minutos y agregación temporal = None 
...
varMinutes = 30
varSeconds = 1800  
varDurationIso = "PT1800S"
varGranularity = "PT30M"
...
# Definición del DAG
@dag(
    dag_id="dag_alarms_aggregation_spatial_30M",  
...
def dag_alarms_aggregation_spatial_30M():  
    @task
...
dag_instance = dag_alarms_aggregation_spatial_30M()