# Nome da DAG: dag_summarization_snmp_interval_group_15M
# Owner / responsável: CoE
# Descrição do objetivo da DAG: Reprocesa las agregaciones por grupo de 15M para un periodo de tiempo estipulado
#
# Nota: 
...
def generar_tareas_druid(fecha, **kwargs):
    functions.druid_create_task_summarization(fecha, "15M", "spatial", "snmp", "interval")    

# Función para insertar un retraso
def esperar():
    time.sleep(15 * 60)  # Espera 30 minutos
...
with DAG(
    "dag_summarization_snmp_interval_group_15M",
