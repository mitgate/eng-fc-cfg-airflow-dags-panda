# Nome da DAG: dag_summarization_snmp_15M
# Owner / responsável: CoE
# Descrição do objetivo da DAG: Ejecuta una tarea index_parallel en Druid para leer datos desde snmp-enriched-metrics y agregarlos en snmp-enriched-metrics-temporal-15m cada 15 minutos, procesando métricas con granularidad de 5 minutos en el ambiente de producción (prd)
#
# Nota: 
