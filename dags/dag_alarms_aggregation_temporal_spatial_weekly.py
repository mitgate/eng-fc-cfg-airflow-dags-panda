# Nome da DAG: dag_alarms_aggregation_temporal_spatial_weekly
# Owner / responsável: CoE
# Descrição do objetivo da DAG: 
# 1. Busca en Postgres Prd los thesholds con granularidad = semana
...
#Definición del Dag
dag = DAG(
    'dag_alarms_aggregation_temporal_spatial_weekly',  # Nombre de tu DAG
