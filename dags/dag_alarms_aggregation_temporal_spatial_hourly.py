# Nome da DAG: dag_alarms_aggregation_temporal_spatial_hourly
# Owner / responsável: CoE
# Descrição do objetivo da DAG: 
# 1. Busca en Postgres Prd los thesholds con granularidad = hora
...
def execute_druid_adapter_query(**kwargs):
    ...
    #start_date = '2024-08-05 13:31:00.000Z'
...
#Definición del Dag
dag = DAG(
    'dag_alarms_aggregation_temporal_spatial_hourly',  # Nombre de tu DAG
