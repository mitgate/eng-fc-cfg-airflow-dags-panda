# Nome da DAG: functions_dev
# Owner / responsável: CoE
# Descrição do objetivo da DAG: Módulo de funciones en Python para el procesamiento de DAGs de Alarmas en el ambiente desarrollo
# Usa Druid?: Si
