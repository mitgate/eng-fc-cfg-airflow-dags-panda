...
TAG_FILTRO = Variable.get("tag_warmup_plataforma") 
...
dag = DAG(
    ...
    description='DAG para filtrar dashboards contendo (PLATAFORMA) e enviar dados para aquecimento de cache',
    schedule_interval='10 0-22/2 * * *',  # Executa a cada 15 minutos
...
def process_dashboards(**kwargs):
    ...
    if response.status_code == 200:
        ...
        # Filtrar dashboards com "(PLATAFORMA)"
